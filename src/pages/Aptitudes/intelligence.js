...
const Intelligence=()=>{
    ...
    return(
        ...
        <View style={{ alignItems: 'center', justifyContent: 'space-around', marginVertical: 20 }}>
                <Apptitude apptitudeLink={require('../../images/aptitudes/apt_hp.webp')} apptitudeName=' % Point de vie' value={pvP} maxvalue='∞' setter={(value) => { dispatch(setpvP(value))
                }} />
                <Apptitude apptitudeLink={require('../../images/aptitudes/apt_resistanceelem.webp')} apptitudeName=' Resistance' value={res} maxvalue={10} setter={(value) => {dispatch(setRES(value))
                }} />
